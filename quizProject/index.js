...
if (answers1.trim().toLowerCase() == "a");
{
  console.log(chalk.red("That is not the correct answer!"));
}
if (answers1.trim().toLowerCase() == "b");
{
  console.log(chalk.red("That is not the correct answer!"));
}
if (answers1.trim().toLowerCase() == "d");
{
  console.log(chalk.red("That is not the correct answer!"));
}
console.log()
...
//   );
// }
// if (answers2.trim().toLowerCase() == "a", "b", "c");
// {
//   console.log(chalk.red("That is not the correct answer!"));
// }
// console.log()
...
//   );
// }
// if (answers4.trim().toLowerCase() == "a", "b", "c");
// {
//   console.log(chalk.red("That is not the correct answer!"));
// }
// console.log()
...
//   );
// }
// if (answers5.trim().toLowerCase() == "a", "b", "c");
// {
//   console.log(chalk.red("That is not the correct answer!"));
// }
// console.log()
...
//   );
// }
// if (answers6.trim().toLowerCase() == "b", "c", "d");
// {
//   console.log(chalk.red("That is not the correct answer!"));
// }
// console.log()
...
//   );
// }
// if (answers7.trim().toLowerCase() == "a", "b", "c");
// {
//   console.log(chalk.red("That is not the correct answer!"));
// }
// console.log()
...
//   );
// }
// if (answers8.trim().toLowerCase() == "a");
// {
//   console.log(chalk.red("That is not the correct answer!"));
// }
// console.log()
...
//   );
// }
// if ((answers9.trim().toLowerCase() == "a", "b", "d"));
// {
//   console.log(chalk.red("That is not the correct answer!"));
// }
// console.log()
...
//   );
// }
// if (answers10.trim().toLowerCase() == "b");
// {
//   console.log(chalk.red("That is not the correct answer!"));
// }
// console.log()
